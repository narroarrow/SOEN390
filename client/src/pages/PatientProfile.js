                ...
                <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', }}>
                    ...
                    <Box sx={{ mt: 10 }}>
                        <Grid container fullwidth spacing={1}>
                            ...
                            <Button xs={12} sm={3} sx={{ margin: 1 }} variant="contained" href="https://www.quebec.ca/en/health/health-issues/a-z/2019-coronavirus/measures-in-force/about-the-measures-in-force">
                                COVID-19 MEASURES
                            </Button>
